...
def create(client):
    ...
    try:        
        ...
        catalog_item = org.get_catalog_item('ACME',
                                            'tinyova')
        ...
        spec = {'source_vm_name': 'Tiny Linux template',
        ...
        spec['target_vm_name'] = 'ubuntu_pcp_6'
        ...
        error_message = '__ERROR_ [create_vdc] failed for vdc {0} '.format(vdc_name)
...
def read_vdc(client):
    ...
    storage_profiles = str(vdc_resource.VdcStorageProfiles.VdcStorageProfile.get('name'))
